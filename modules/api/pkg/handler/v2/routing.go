...
type Routing struct {
	...
	clusterBackupStorageLocationProviderGetter provider.CBSLProviderGetter
	// privilegedClusterBackupStorageLocationProviderGetter provider.PrivilegedCBSLProviderGetter
...
func NewV2Routing(routingParams handler.RoutingParams) Routing {
	return Routing{
		...
		clusterBackupStorageLocationProviderGetter: routingParams.CBSLProviderGetter,
		// privilegedClusterBackupStorageLocationProviderGetter: routingParams.PrivilegedCBSLProviderGetter,
